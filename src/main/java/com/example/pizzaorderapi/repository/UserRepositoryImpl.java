...
public class UserRepositoryImpl implements UserRepository {
    ...
    private static final String SQL_CREATE="INSERT INTO P_USERS(USER_ID,FIRST_NAME,LAST_NAME,EMAIL,PASSWORD) VALUES(NEXTVAL('P_USERS_SEQ'),?,?,?,?)";
    private static final String SQL_COUNT_BY_EMAIL="SELECT COUNT(*) FROM P_USERS WHERE EMAIL=?";
    private static final String SQL_FIND_USER_BY_ID="SELECT USER_ID,FIRST_NAME,LAST_NAME,EMAIL,PASSWORD FROM P_USERS WHERE USER_ID=?";
    private static final String SQL_FIND_BY_EMAIL="SELECT USER_ID,FIRST_NAME,LAST_NAME,EMAIL,PASSWORD FROM P_USERS WHERE EMAIL=?";
    ...
    public Integer create(String firstName, String lastName, String email, String password) throws EtAuthException {
        try {
            ...
            return (Integer) key.getKeys().get("USER_ID");
        }
        catch (Exception e){
